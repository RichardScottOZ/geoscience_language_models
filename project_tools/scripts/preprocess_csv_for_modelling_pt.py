...
import nrcan_p2.data_processing.preprocessing_dfcol_pt as preprocessing_str_pt
#import nrcan_p2.data_processing.preprocessing_dfcol_pt as preprocessing_dfcol
#import nrcan_p2.data_processing.preprocessing_dfcol_pt as preprocessing_str
...
def process_pre_pipeline_step(col:str, 
    ...
    print("name of preprocessing",preprocessing_func_module, preprocessing_func)
    #if preprocessing_func_module == 'preprocessing_dfcol':
    if preprocessing_func_module == 'preprocessing_dfcol_pt':        
        try:
    ...
    elif preprocessing_func_module == 'preprocessing_df_filter_pt':
        ...
        #("NOT FOUND:", preprocessing_func_module)
        ...
        if next_temp_file.exists():
            ...
            try:
                with open(next_temp_file, 'w') as f:
                    f.write(text)
            except Exception as encodingwriteE:
                with open(next_temp_file, 'w', encoding='"iso-8859-1"') as f:
                    f.write(text)
