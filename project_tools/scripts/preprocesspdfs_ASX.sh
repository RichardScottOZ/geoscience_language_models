...
do
    ...
    CMD="python scripts/pdf_to_txt.py --NFILE_RANGE $start $end --N_FILES -1 --WRITE_OUTPUT --LOCAL_DIR /home/ubuntu/data/pyasx/pyasx/asxpdf/ --OUTPUT_DIR /home/ubuntu/data/asx_pdfout/"
