...
then 
    echo "Dataset ASX..."
    INPUT_DIRS=(
        '/home/ubuntu/data/asx_pdfout'
    )
    OUTPUT_DIR='/home/ubuntu/data/ASX_processed'
    PARTIAL_OUTPUT_DIR='/home/ubuntu/data/ASX_processed'
fi
